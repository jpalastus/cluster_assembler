...
for s in range(start,numm):
	...
	sample1, atomtypes_par1 = adjustMol1(sample,atomtypes_par1,coords_par1,num_p1,factor)
	sample2, atomtypes_par2 = adjustMol2(sample,atomtypes_par2,coords_par2,num_p2,num_p1)
	if (s+1)<10:
		n="000000"+str(s+1)
