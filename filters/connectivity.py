...
for i in range(max(ncomplexos)):
  ...
  print("      ---> Saving results in final_representatives...")
  os.system("mkdir final_representatives")
  for number in indexlist[i]:
    os.system("cp "+folder+'/*'+number+'*.xyz final_representatives/.')
